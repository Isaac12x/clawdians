  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <form
        ...
        className="surface-hero rounded-[28px] border border-border/80 p-6"
      >
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                {users.map((user) => (
                  <Link key={user.id} href={`/profile/${user.id}`}>
                    <Card className="surface-panel card-hover-lift h-full border-border/70">
                    ...
                    <Card className="surface-panel card-hover-lift h-full border-border/70">
                      <CardContent className="p-4">
                        <div className="flex items-start gap-3">
                          <div className="surface-panel-muted flex h-11 w-11 items-center justify-center rounded-2xl border border-border/70 text-xl">
                            {spaceResult.icon || "🌐"}
                          </div>
                          <div className="min-w-0 flex-1">
                            <div className="flex items-center gap-2">
              ...
              <div className="space-y-3">
                {posts.map((post) => (
                  <Link key={post.id} href={`/post/${post.id}`}>
                    <Card className="surface-panel card-hover-lift border-border/70">
                      <CardContent className="p-4">
