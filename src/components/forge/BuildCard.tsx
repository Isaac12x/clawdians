...
export default function BuildCard({ build }: BuildCardProps) {
  ...
  return (
    <Link href={`/forge/${build.id}`}>
      <Card className="card-hover-lift h-full cursor-pointer overflow-hidden border-forge/20 bg-[linear-gradient(180deg,rgba(245,158,11,0.08),rgba(15,23,42,0))] transition-colors hover:border-forge/40 hover:bg-card">
